...
String getTrayImagePath(String imageName) {
  return Platform.isLinux ? 'assets/$imageName.ico' : 'assets/$imageName.png';
}

String getImagePath(String imageName) {
  return Platform.isLinux ? 'assets/$imageName.bmp' : 'assets/$imageName.png';
}
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initSystemTray() async {
    ...
    _systemTray.setTitle("Worstatus");
    _systemTray.setToolTip("Workstatus time_log");
                      ...
                      onPressed: () async {
                        if (await systemTray.initSystemTray(
                          ...
                          Timer.periodic(Duration(seconds: 1), (timer) {
                            ...
                            systemTray.setTitle(formattedDate);
                          });
